...
build_dep = ['setuptools>=38', 'numpy>=1.23,<2.4', 'pybind11>=2.2']
run_dep = ['galsim>=2.4', 'numpy>=1.23,<2.4', 'scipy>=1.2', 'pyyaml>=5.1', 'treecorr>=4.3.1', 'fitsio>=1.0', 'matplotlib>=3.6', 'LSSTDESC.Coord>=1.0', 'treegp>=1.3', 'threadpoolctl>=3.1']
