...
template<class T>
auto _solve_direct_cpp_impl_test(
...
auto _solve_direct_cpp_test(
    ...
    return _solve_direct_cpp_impl_test<T>(bList, AList, KList,  K_buffer_info.shape[0]);
...
PYBIND11_MODULE(basic_solver_test, m) {
    m.def("_solve_direct_cpp_test", &_solve_direct_cpp_test<float>, py::return_value_policy::move,
        py::arg("bList"),py::arg("AList"),py::arg("KList") );
    m.def("_solve_direct_cpp_test", &_solve_direct_cpp_test<double>, py::return_value_policy::move,
        py::arg("bList"),py::arg("AList"),py::arg("KList") );
}
